...
export const RectShape = memo(props => {
    ...
    return (React.createElement(AnimatedRect, { x: origin.current.x, y: origin.current.y, width: size.current.x, height: size.current.y, opacity: opacity.current, fill: "black", rx: 4, ry: 4 }));
}, isEqual);
